...
import com.example.mediationapp.service.FirebaseRepository
...
class AuthViewModel : ViewModel() {
    ...
    private fun validateRegistrationInputString(email : String, password : String, name: String, age: String) : Boolean{
